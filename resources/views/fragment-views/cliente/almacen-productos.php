    ...
    <div class="modal fade" id="modal-add-prod" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
			    ...
			    <div class="form-group col-md-3 mt-2">
                                <label>Costo (S/)</label>
                                <input v-model="reg.costopen" @keypress="onlyNumber" required value="0" type="text" class="form-control">
                            </div>
                            <div class="form-group col-md-3 mt-2">
                                <label>Costo ($)</label>
                            ...
                            <div class="form-group col-md-4 mt-2">
                                ...
                                <input v-model="reg.precioDolar" @keypress="onlyNumber" required value="0" type="text" class="form-control">
                            </div>
    ...
    <div class="modal fade" id="modal-edt-prod" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
			    ...
			    <div class="form-group col-md-3 mt-2">
                                <label>Costo (S/)</label>
                                <input v-model="edt.costop" @keypress="onlyNumber" required value="0" type="text" class="form-control">
                            </div>
			    <div class="form-group col-md-3 mt-2">
                                <label>Costo ($)</label>
			    ...
			    <div class="form-group col-md-4">
                                ...
                                <input v-model="edt.precioDolar" @keypress="onlyNumber" required value="0" type="text" class="form-control">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label><span class="rojo"></span>RUC: </label>
                                        <div class="input-group">
                                            <input @change="ChangeconsultarDocRUC" v-model="edt.ruc" required @keypress="onlyNumber" type="text" class="form-control" maxlength="11">
                                            <div class="input-group-prepend">
                                                <button type="button" @click="consultarDocRUC" class="btn btn-primary"><i class="fa fa-search"></i></button>
                                            </div>
                                        </div>
                        ...
                        <div class="mb-3">
                            <p>Descargue el modelo en <span class="fw-bold">EXCEL</span> para importar, no
                                modifique los campos en el archivo, <span class="fw-bold">click para
                                    descargar</span> <a href="<?=URL::to('public/plantillaproductoss.xlsx')?>">plantilla.xlsx</a></p>
                        </div>
                        <div class="mb-3">
        ...
        const app = new Vue({
            ...
            methods: {
                ...
                setInfo(data) {
                    ...
                    this.edt.precioDolar = data.precio3
		    this.edt.costop = data.costop
